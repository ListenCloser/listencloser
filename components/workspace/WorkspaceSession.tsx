...
const OPTIONAL_ANALYSIS_CAPABILITIES = new Set(["melody_audition", "separate", "structure_map", "symbolic_detail"]);
...
export default function WorkspaceSession({ serviceStatus }: { serviceStatus: ServiceStatus }) {
  ...
  }, [loadWork, projectId, queryClient, serviceStatus, setScoreDisplaySelection, workspace.activeWorkId]);
