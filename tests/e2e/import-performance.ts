 ...
 *
 * Timing is intentionally relative to the file-selection attempt and uses the
 * test runner's monotonic clock. IDs, filenames, and musical content are never
 * recorded in the report. The listener stays alive through progressive Work
 * polling so the report can also expose how many full bundle responses were
 * needed before the Work became fully enriched.
 */
