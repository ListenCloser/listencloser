...
class SymbolicDetailReport(BaseModel):
    ...
    limitations: list[str] = Field(
        default_factory=lambda: [
            "MIDI score import may infer voice/staff organization that was not present in the source.",
            ...
            "Density and texture are symbolic note-event measurements, not audio loudness or timbre.",
        ]
    )
