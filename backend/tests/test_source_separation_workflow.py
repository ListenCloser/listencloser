...
def test_separate_workflow_targets_original_for_durable_bundle_truth(
    client,
    ...
    # The Work bundle discovers jobs via workflows targeting one of the Work's
    # immutable Versions. Optionality is a presentation/state concern, not a
    # reason to hide the durable separation Job from reload truth.
